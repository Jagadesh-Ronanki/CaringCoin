const { simulateRequest, getDecodedResultLog, getRequestConfig } = require("../src/backend/FunctionsSandboxLibrary")
...
;(async () => {
  const unvalidatedRequestConfig = require("../function-request-config.js")
